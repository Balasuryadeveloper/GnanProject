...
<body>
<div class="mt-5">
  <center><h1 class="mb-3 text-primary"><u> CCTV <br>CCTV 3+1 Cable</u></h1></center>
<table class="table table-hover table-striped table-bordered">
  ...
  $con=new mysqli("localhost","root","","itsmsofttech");
    $sql = "SELECT * FROM newstockentry WHERE (Stock_Type = 'Consumable' and Items = 'CCTV 3+1 Cable')";
